...
qs::qsave(multinichenet_output, file = "~/projects/Everolimus_Resistance_ccRCC/analysis/data/05_determine_key_mps_subcluster/01_multinichenetr_mps/01_multinichenet_output.qs")
...
print(p)
ggsave("analysis/figure/05_determine_key_mps_subcluster/01_multinichenetr_mps/01_multinichenetr_TNF_dotplot.pdf", p, width = 10.27, height = 4.56)
